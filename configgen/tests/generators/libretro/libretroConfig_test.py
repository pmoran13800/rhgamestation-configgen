...
rhgamestationConfFile = os.path.abspath(os.path.join(os.path.dirname(__file__), 'tmp/rhgamestation.conf'))
...
class TestLibretroConfig(unittest.TestCase):
    def setUp(self):
        # Injecting test file
        recalSettings.settingsFile = rhgamestationConfFile
