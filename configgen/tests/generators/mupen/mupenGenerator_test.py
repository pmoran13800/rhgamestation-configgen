...
mupenControllers.rhgamestationFiles.mupenCustom = MUPEN_CUSTOM_CFG_FILE
    ...
    def test_commandline_core_n64(self):
        ...
        self.assertEquals(command.array,
                          ['mupen64plus', '--corelib', '/usr/lib/libmupen64plus.so.2.0.0', '--gfx',
                           '/usr/lib/mupen64plus/mupen64plus-video-n64.so', '--configdir', '/rhgamestation/configs/mupen64/',
                           '--datadir', '/rhgamestation/configs/mupen64/', "rom.n64"])
