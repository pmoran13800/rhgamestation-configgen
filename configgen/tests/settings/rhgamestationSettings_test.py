...
import configgen.settings.rhgamestationSettings as recalSettings

shutil.copyfile(os.path.abspath(os.path.join(os.path.dirname(__file__), "../resources/rhgamestation.conf.origin")), \
                os.path.abspath(os.path.join(os.path.dirname(__file__), "tmp/rhgamestation.conf")))


# Injecting test rhgamestation.conf
recalSettings.settingsFile = os.path.abspath(os.path.join(os.path.dirname(__file__), "tmp/rhgamestation.conf"))


class TestRHGamestationSettings(unittest.TestCase):
