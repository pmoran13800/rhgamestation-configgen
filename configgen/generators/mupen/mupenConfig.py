...
def setPaths():
	mupenSettings.save('ScreenshotPath', rhgamestationFiles.SCREENSHOTS)
	mupenSettings.save('SaveStatePath', rhgamestationFiles.mupenSaves)
	mupenSettings.save('SaveSRAMPath', rhgamestationFiles.mupenSaves)
